...
const party = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { type: "action", job: "Monk", skill: "Chakra", note: "No-MP self/ally HP+MP restore — cheap sustain to bank while grinding Monk toward Lv.4, which unlocks Geomancer. Confirm the exact name in TIC." },
      { type: "reaction", job: "Monk", skill: "Counter", note: "Strikes back when physically hit — a lasting reaction option for a front-line striker; bank it during the Monk pass. Confirm the exact name in TIC." },
      { type: "action", job: "Geomancer", skill: "Geomancy", note: "No-MP terrain attack that banks Geomancer JP toward Lv.2 — the confirmed Ninja unlock; a handy ranged poke while you clear the gate. Confirm the exact name in TIC." },
      { type: "support", job: "Geomancer", skill: "Attack Up", note: "The Geomancer keeper worth the detour — raises her physical damage for good; a strong option on her endgame Ninja. Confirm the exact name in TIC." },
    ...
    notes: [
      ...
      "**The Monk → Geomancer gate:** Ninja needs **Geomancer Lv.2** (confirmed), and Geomancer itself needs **Monk Lv.4** (confirmed) — so it's a deep detour: Monk opens from Knight, take Monk to Lv.4 to unlock Geomancer, then grind Geomancer to Lv.2. Bank that JP before expecting Ninja to open — and make it pay: grab **Counter/Chakra** during the Monk pass, and **Attack Up** (a permanent physical-damage keeper) in Geomancer.",
    ...
    loadouts: [
      ...
      { job: "Geomancer (Lv.2 gate)", secondary: "Steal (kept from Thief) or Item", reaction: "Vigilance — kept from Thief so she still guards on HP loss", support: "JP Boost — the fastest way to Geomancer Lv.2, the confirmed Ninja unlock; learn Attack Up here to keep for good", movement: "Move +2 (kept from Thief)", why: "Geomancer Lv.2 is the confirmed unlock for Ninja, so this is the last piece of the gate. It's a real detour (Knight Lv.3 → Monk Lv.4 opens Geomancer), so make it pay: bank Attack Up while you're here — it raises her physical damage for good — then move into Ninja." },
