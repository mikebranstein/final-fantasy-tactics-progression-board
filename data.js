...
const party = [
  {
    ...
    gear: [
      ...
      { name: "Sprint Shoes", type: "accessory", when: "Ch.3 — Yardrow shop", note: "+1 Speed = more Iaido turns. (TIC name: Hermes Shoes.)" },
      { name: "Excalibur", type: "weapon", when: "Ch.4 — Orlandeau joins wielding it", note: "Top knight's sword; grants permanent Haste (Auto-Haste) and a Holy boost. Needs Equip Swords on a Samurai." },
      { name: "Save the Queen", type: "weapon", when: "Ch.4 — Meliadoul joins with it (or steal from Loffrey)", note: "Knight's sword that grants permanent Protect. (Not from the Beowulf sidequest.)" },
      { name: "Genji set (Armor/Helm/Shield)", type: "armor", when: "Ch.4 — steal from Elmdore at Limberry Castle", note: "Elmdore has Safeguard — strip it first; top-tier heavy gear." },
      { name: "Masamune", type: "weapon", when: "Ch.4 — steal from a samurai (Elmdore has Safeguard in TIC)", note: "Best all-round katana — a strong Draw Out (Ethereal Embrace: Regen + Haste). Can't be bought." },
      { name: "Grand Helm / Maximillian", type: "armor", when: "Postgame — Midlight's Deep treasures", note: "Best helm and heavy body armor for a frontline Samurai." },
      { name: "Ragnarok", type: "weapon", when: "Postgame — Midlight's Deep (Treasure Hunter)", note: "Top knight's sword; grants permanent Shell (Auto-Shell)." },
      { name: "Chirijiraden", type: "weapon", when: "Postgame — Midlight's Deep (final floor)", note: "The ultimate katana and his biggest Iaido nuke (Raging Inferno). Not found at Nelveska Temple." },
    ],
  ...
  },
  {
    ...
    gear: [
      { name: "Holy Miter", type: "armor", when: "Ch.3 — Lesalia shop", note: "Magick-boosting hat for casters (+1 Magick Attack). (TIC name: Celebrant's Miter.)" },
      { name: "White Robe", type: "armor", when: "Ch.3 — Monastery Vaults shop", note: "Halves Fire/Ice/Lightning and raises Magick Defense — great on a healer." },
      { name: "108 Gems / N-Kai Armlet", type: "accessory", when: "Ch.3 — shops", note: "Blocks common status attacks so your healer stays online. (TIC names: Japa Mala / Nu Khai Armband.)" },
      { name: "Healing Staff", type: "weapon", when: "Ch.4 — treasure at Eagrose Castle or poach a Dryad", note: "Attacking a wounded ally heals them — a free extra heal each turn. (Not a shop item.)" },
      { name: "Chantage", type: "accessory", when: "late — poach (female-only Perfume)", note: "Perpetual Reraise + Regen — Orrick is male, so use Reflect Ring or Defense Ring instead." },
      { name: "Whale Whisker", type: "weapon", when: "Postgame — poach a Tiamat", note: "The biggest Magick boost of any staff." },
      { name: "Robe of Lords", type: "armor", when: "Postgame — Midlight's Deep", note: "Best all-round robe (Auto-Protect + Auto-Shell). (TIC name: Lordly Robe.)" },
    ],
  ...
  },
  {
    ...
    gear: [
      { name: "Flame / Ice / Thunder Rod", type: "weapon", when: "Ch.1 — Zeklaus Desert shop", note: "Each boosts its element and can cast a free spell — match to your Black Magic. Cheap and available very early." },
      { name: "Wizard's Staff / Wizard's Rod", type: "weapon", when: "Ch.2–3 — shops", note: "Flat Magick boost for spells and summons (Mage's Staff +1, Wizard's Rod +2 Magick Attack)." },
      { name: "Black Robe", type: "armor", when: "Ch.3 — Yardrow shop", note: "Boosts Fire/Ice/Lightning damage — ideal during her Black Mage phase." },
      { name: "Golden Hairpin", type: "armor", when: "Ch.3 — Yardrow shop", note: "+50 MP hat to fuel back-to-back summons. (TIC name: Gold Hairpin.)" },
      { name: "Sprint Shoes", type: "accessory", when: "Ch.3 — Yardrow shop", note: "+1 Speed = more casts. (TIC name: Hermes Shoes.)" },
      { name: "Light Robe", type: "armor", when: "Ch.4 — shop", note: "All-round magick body armor once non-elemental summons matter more. (TIC name: Luminous Robe.)" },
      { name: "Faith Rod", type: "weapon", when: "Postgame — Midlight's Deep treasure", note: "Raises Faith for more magick damage (but she also takes more — situational). (TIC name: Rod of Faith.)" },
      { name: "Whale Whisker", type: "weapon", when: "Postgame — poach a Tiamat", note: "Biggest flat Magick boost for summons and spells." },
      { name: "Robe of Lords", type: "armor", when: "Postgame — Midlight's Deep", note: "Best all-round robe. (TIC name: Lordly Robe.)" },
    ],
  ...
  },
  {
    ...
    gear: [
      { name: "Windslash Bow", type: "weapon", when: "Ch.3 — Monastery Vaults shop", note: "Wind-element longbow with extra vertical range — snipe from cliffs." },
      { name: "Assassin's Dagger", type: "weapon", when: "Ch.3 — Yardrow shop", note: "Chance to inflict Doom on hit — brutal with Dual Wield." },
      { name: "Sprint Shoes / Germinas Boots", type: "accessory", when: "Ch.3 — shops", note: "Speed (Hermes Shoes, +1 Speed) or Move +1 / Jump +1 (Germinas Boots) for a fast mobile striker." },
      { name: "Vanish Mantle", type: "accessory", when: "Ch.4 — Treasure Hunter at Germinas Peak", note: "Top evasion cloak; starts the battle Invisible — pairs with her innate evasion + Reflexes. (TIC name: Invisibility Cloak.)" },
      { name: "Perseus Bow / Yoichi Bow", type: "weapon", when: "Ch.4 steal (Yoichi) / postgame (Perseus)", note: "Best bows for her Archer phase — two-hand them for big ranged damage." },
      { name: "Thief Hat / Flash Hat", type: "armor", when: "Ch.4 — shops", note: "Speed-boosting light headgear for Thief/Ninja (Thief's Cap +2 Speed; Lambent Hat +1 Speed / +1 Magick)." },
      { name: "Koga Knife / Iga Knife", type: "weapon", when: "Postgame — Midlight's Deep treasures", note: "Best ninja blades; dual-wield a pair for her endgame." },
    ],
  ...
  },
  {
    ...
    gear: [
      { name: "Monster Dictionary / Papyrus Plate (Books)", type: "weapon", when: "Ch.2–3 — shops", note: "Arithmetician weapons; books strike two tiles in a row. (TIC names: Bestiary / Papyrus Codex.)" },
      { name: "Chameleon Robe", type: "armor", when: "Ch.3 — Lesalia shop", note: "Absorbs Holy — cast Holy via Arithmeticks to heal herself/allies with zero friendly-fire risk." },
      { name: "Black Robe", type: "armor", when: "Ch.3 — Yardrow shop", note: "Boosts elemental Arithmeticks damage." },
      { name: "Magepower Glove", type: "accessory", when: "Ch.3 — shop", note: "+2 Magick Attack for stronger calculations — the single-player magick-boost accessory (Sage's Ring is multiplayer-only)." },
      { name: "Sprint Shoes", type: "accessory", when: "Ch.3 — Yardrow shop", note: "+1 Speed = noticeably more Arithmeticks turns. (TIC name: Hermes Shoes.)" },
      { name: "Ribbon", type: "armor", when: "Ch.4 — poach (rare, female-only)", note: "Best hat in the game — blocks nearly all status ailments." },
      { name: "Whale Whisker", type: "weapon", when: "Postgame — poach a Tiamat", note: "If she fires Arithmeticks from a staff-using mage body, this maximizes magick." },
      { name: "Robe of Lords", type: "armor", when: "Postgame — Midlight's Deep", note: "The all-round magick robe. (TIC name: Lordly Robe.)" },
    ],
...
const missables = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Gather Esdeline's ninja blades",
        note: "**Assassin's Dagger** is a **Ch.3 Yardrow shop** buy; the **Koga/Iga Knives** are **postgame Midlight's Deep** treasures (not poached from ninjas). None are one-time story misses.",
      },
      {
        label: "Sweep Nelveska Temple for its one-time treasures",
        note: "The one-time Worker 7 map hides rare Move-Find loot (e.g. **Sasuke's Blade**) — sweep it before you leave. Note: **Chirijiraden is not here** — it's a postgame Midlight's Deep find.",
      },
      {
    ...
    items: [
      {
        ...
        note: "The one-time **Worker 7** map is worth a full Move-Find sweep before you leave — you won't get another pass.",
      },
      {
...
const recruits = [
  {
    ...
    gear: [
      { name: "Excalibur", type: "weapon", when: "Ch.4 — Orlandeau joins wielding it", note: "Permanent Haste plus a Holy boost — arguably her best blade." },
      { name: "Save the Queen", type: "weapon", when: "Ch.4 — Meliadoul joins with it (or steal from Loffrey)", note: "Knight's Sword granting permanent Protect — excellent on her. (Not from the Beowulf sidequest.)" },
      { name: "Genji Armor", type: "armor", when: "Ch.4 — steal from Elmdore", note: "Top heavy armour for a front-line Holy Knight (Grand Armor is multiplayer-only)." },
    ],
    braveFaith:
  ...
  },
  {
    ...
    gear: [
      { name: "Status-blocking accessory (108 Gems / N-Kai Armlet)", type: "accessory", when: "Ch.3 — shops", note: "Keeps him acting freely from the back line." },
      { name: "Blaze / Glacier / Blast Gun", type: "weapon", when: "Ch.4 — steal from enemy chemists", note: "Elemental guns fire a fixed-power elemental shot at long range (and can cast their element). Not shop-bought." },
    ],
  ...
  },
  {
    ...
    gear: [
      { name: "Excalibur", type: "weapon", when: "Ch.4 — he joins already wielding it", note: "Permanent Haste and a Holy boost — his signature blade." },
      { name: "Genji set", type: "armor", when: "Ch.4 — steal from Elmdore", note: "Top heavy gear, though he rarely needs the bulk (Grand Armor is multiplayer-only)." },
    ],
    braveFaith:
